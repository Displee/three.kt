...
class Matrix4(
    ...
    fun invert(): Matrix4 {
        ...
        if (det == 0f) {
            // Match Three.js behavior: reset to identity
            return identity()
        }
